{* home_page.tpl *}
{load_presentation_object filename="home_page" assign="obj"}
...
alt="{$obj->mProducts[k].name}" style="width:100px;"/>
</a>
{/if}
...
{if $smarty.section.l.first ||$obj->mProducts[k].attributes[l].attribute_name !==
...
<!--<p><input type="submit" name="submit" value="Add to Cart" /></p>before AJAX is implemented-->
